            ...
            if client.user.id not in mscDICT:    # 判斷 User 是否為第一輪對話
                ...
                # 先處理「簡答題」
                    ...
                    #改預約時間、診所、醫師
                        ...
                        if any(e in msgSTR for e in ["對","正確","沒錯"]) and "不" not in msgSTR:
